...
export class CharactersComponent {
  characters = [
    ...
    { id: 2, name: 'Цири', aka: 'ЛАСТОЧКА', description: 'Принцесса Цинтры, носительница Elder Blood. Дочь Паветты.', weapon: 'Меч из Ласточки', origin: 'Цинтра', image: 'https://images.unsplash.com/photo-1542574271-7f3b92e6c821?w=400&h=500&fit=crop' },
